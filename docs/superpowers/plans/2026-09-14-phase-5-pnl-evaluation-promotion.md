...
- [ ] **Step 3: Implement deterministic metrics with zero-denominator handling**
...
- [ ] **Step 1: Write failing tests for every promotion condition**
...
- [ ] **Step 3: Add repository aggregation and authenticated read-only endpoint**
...
- [ ] **Step 4: Render evidence and eligibility without enable buttons**
...
- [ ] **Step 5: Run API/web tests and commit**
...
- [ ] **Step 1: Add an audit script that opens a read-only transaction**
...
- [ ] **Step 2: Run the audit against the test database**
...
- [ ] **Step 4: Run the production audit only with explicit read-only credentials/transaction**

Run: `pnpm --filter @platform/api audit:recovery-rollout`
Expected: JSON report; no writes, pipeline triggers, configuration mutations, or exchange calls.

- [ ] **Step 5: Document rollout evidence and commit**
