...
- [ ] **Step 3: Implement deterministic field comparison and maturity thresholds**
...
- [ ] **Step 1: Add failing policy tests for 1h/15m mismatch and negative exact evidence**
...
- [ ] **Step 3: Replace implicit latest-row fallback with exact status handling**
...
- [ ] **Step 3: Add the backward-compatible shared schema and populate it in calibration**
...
- [ ] **Step 4: Make Risk fail closed on missing/unreliable execution probability where required**
...
- [ ] **Step 5: Run shared and API tests, then commit**
