...
- [x] **Step 1: Write failing fixtures for sweep, reclaim, confirmation, chase, invalidation, and same-candle flip**
...
- [x] **Step 3: Implement the pure transition function**
...
- [x] **Step 1: Add failing tests for legal persistence and idempotent cutoff handling**
...
- [x] **Step 3: Extend shared snapshot evidence and map recovery states onto existing Opportunity states**
...
- [x] **Step 4: Persist transition evidence and versions using existing idempotency keys**
...
- [x] **Step 1: Add a failing end-to-end shadow test**
...
- [x] **Step 3: Add recovery setup selection without overriding canonical regime/location**
...
- [x] **Step 4: Force the new setup to SHADOW regardless of deployment trading mode**
