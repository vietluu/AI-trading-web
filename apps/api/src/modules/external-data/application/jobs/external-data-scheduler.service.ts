...
export const DEFAULT_EXTERNAL_DATA_SOURCES = [
  {
  ...
  },
  {
    ...
    displayName: "Decrypt Main Feed",
    provider: ExternalDataProvider.GENERIC_RSS,
    sourceType: NewsSourceType.RSS,
    baseDomain: "decrypt.co",
    feedUrl: "https://decrypt.co/feed",
    language: "en",
    categories: ["news", "market", "technology"],
    reliabilityScore: 85,
    pollIntervalSeconds: 300,
    isEnabled: true,
  },
  {
    sourceId: "blockworks-rss",
    displayName: "Blockworks Main Feed",
    provider: ExternalDataProvider.GENERIC_RSS,
    sourceType: NewsSourceType.RSS,
    baseDomain: "blockworks.com",
    feedUrl: "https://blockworks.com/feed",
    language: "en",
    categories: ["news", "market", "institutional"],
    reliabilityScore: 84,
    pollIntervalSeconds: 300,
    isEnabled: true,
  },
  {
    sourceId: "cryptoslate-rss",
    displayName: "CryptoSlate Main Feed",
    provider: ExternalDataProvider.GENERIC_RSS,
    sourceType: NewsSourceType.RSS,
    baseDomain: "cryptoslate.com",
  ...
  {
    sourceId: "bitcoin-magazine-rss",
    displayName: "Bitcoin Magazine Feed",
    provider: ExternalDataProvider.GENERIC_RSS,
    sourceType: NewsSourceType.RSS,
    baseDomain: "bitcoinmagazine.com",
    feedUrl: "https://bitcoinmagazine.com/.rss/full/",
    language: "en",
    categories: ["news", "bitcoin", "market"],
    reliabilityScore: 78,
    pollIntervalSeconds: 300,
    isEnabled: true,
  },
  {
    sourceId: "dl-news-rss",
    displayName: "DL News Main Feed",
    provider: ExternalDataProvider.GENERIC_RSS,
    sourceType: NewsSourceType.RSS,
    baseDomain: "dlnews.com",
    feedUrl: "https://www.dlnews.com/arc/outboundfeeds/rss/",
    language: "en",
    categories: ["news", "defi", "regulation"],
    reliabilityScore: 86,
    pollIntervalSeconds: 300,
    isEnabled: true,
  },
  {
    sourceId: "sec-press-releases-rss",
    displayName: "U.S. SEC Press Releases",
    provider: ExternalDataProvider.GENERIC_RSS,
    sourceType: NewsSourceType.RSS,
    baseDomain: "sec.gov",
    feedUrl: "https://www.sec.gov/news/pressreleases.rss",
    language: "en",
    categories: ["official", "regulation", "enforcement"],
    reliabilityScore: 100,
    pollIntervalSeconds: 900,
    isEnabled: true,
  },
  {
    sourceId: "federal-reserve-press-rss",
    displayName: "Federal Reserve Press Releases",
    provider: ExternalDataProvider.GENERIC_RSS,
    sourceType: NewsSourceType.RSS,
    baseDomain: "federalreserve.gov",
    feedUrl: "https://www.federalreserve.gov/feeds/press_all.xml",
    language: "en",
    categories: ["official", "macro", "monetary-policy"],
    reliabilityScore: 100,
    pollIntervalSeconds: 900,
    isEnabled: true,
  },
  {
    sourceId: "cftc-press-releases-rss",
    displayName: "U.S. CFTC Press Releases",
    provider: ExternalDataProvider.GENERIC_RSS,
    sourceType: NewsSourceType.RSS,
    baseDomain: "cftc.gov",
    feedUrl: "https://www.cftc.gov/RSS/RSSGP/rssgp.xml",
    language: "en",
    categories: ["official", "regulation", "derivatives"],
    reliabilityScore: 100,
    pollIntervalSeconds: 900,
    isEnabled: true,
  },
...
export class ExternalDataSchedulerService implements OnApplicationBootstrap {
  ...
  private async seedDefaultSources() {
    const defaultSources = DEFAULT_EXTERNAL_DATA_SOURCES;
