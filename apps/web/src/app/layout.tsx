          ...
          <div className="mx-auto flex min-h-screen max-w-7xl flex-col px-5 sm:px-8">
            <header className="flex min-h-20 flex-wrap items-center justify-between gap-4 border-b border-border py-4">
              ...
              <nav className="flex flex-wrap items-center gap-1 text-sm">
                ...
                <Link className="rounded-lg px-3 py-2 hover:bg-muted" href="/ai/pipeline">
                  Automation
                </Link>
                <Link className="rounded-lg px-3 py-2 hover:bg-muted" href="/ai/performance">
                  Performance
                </Link>
                <Link className="rounded-lg px-3 py-2 hover:bg-muted" href="/ai/paper-trading">
                  Paper Trading
                </Link>
                <Link
                  className="rounded-lg px-3 py-2 hover:bg-muted"
